...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.EntityModel.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Model.EntityModel.Student", b =>
                {
                    b.HasBaseType("Model.EntityModel.Person");
            ...
            modelBuilder.Entity("Model.EntityModel.Teacher", b =>
                {
                    b.HasBaseType("Model.EntityModel.Person");
            ...
            modelBuilder.Entity("Model.EntityModel.Student", b =>
                {
                    b.HasOne("Model.EntityModel.Person", null)
                        .WithOne()
                        .HasForeignKey("Model.EntityModel.Student", "Id")
            ...
            modelBuilder.Entity("Model.EntityModel.Teacher", b =>
                {
                    b.HasOne("Model.EntityModel.Person", null)
                        .WithOne()
                        .HasForeignKey("Model.EntityModel.Teacher", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
